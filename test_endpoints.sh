...
assert_get "/api/v1/health" '"ok":true' "JSON health"
assert_get "/api/v1/health" '"program_loaded":true' "JSON health reports program"
assert_get "/api/v1/version" '"plugin":"GhidraMCP-next"' "JSON version"
assert_get "/api/v1/version" '"api_version":"1"' "JSON version reports API"
assert_get "/api/v1/list_functions" '"functions":[' "JSON list_functions"
assert_get "/api/v1/list_functions" "\"name\":\"$FUNC_NAME\"" "JSON list_functions includes function"
assert_get "/api/v1/get_function_by_address?address=$FUNC_ADDR" '"function":{' "JSON get_function_by_address"
assert_get "/api/v1/get_function_by_address?address=$FUNC_ADDR" "\"entry\":\"$FUNC_ADDR\"" "JSON get_function_by_address reports entry"
assert_get "/api/v1/decompile_function?address=$FUNC_ADDR" '"decompile":' "JSON decompile_function"
